/**
 * @file SparkFlex.hpp
 * @brief Header file for the SparkFlex class for controlling REV Robotics SPARK
 * Flex controllers
 ...
 *
 * This class provides methods to configure, control, and monitor the SPARK
 * Flex. It supports various control modes, parameter settings, and status
 * readings.
 */
